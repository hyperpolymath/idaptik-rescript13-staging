...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/idaptik/security/advisories/new)
...
- This repository (`hyperpolymath/idaptik`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/idaptik/security/advisories)
