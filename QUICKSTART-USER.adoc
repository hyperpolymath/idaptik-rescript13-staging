...
// Replace idaptik-rescript13-staging, Idaptik Rescript13 Staging — See README.adoc for details., just run, Idaptik Rescript13 Staging started successfully. with actuals
= idaptik-rescript13-staging — Quick Start for Users
:toc:
:toclevels: 2

== What is idaptik-rescript13-staging?

Idaptik Rescript13 Staging — See README.adoc for details.
...
----
# Clone and set up
git clone https://github.com/hyperpolymath/idaptik-rescript13-staging.git
cd idaptik-rescript13-staging
just setup
----
...
[source,bash]
----
just install --portable --prefix=./idaptik-rescript13-staging-portable
----
...
[source]
----
Idaptik Rescript13 Staging started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/idaptik-rescript13-staging/wiki
