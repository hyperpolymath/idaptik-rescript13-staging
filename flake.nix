{
  description = "idaptik-rescript13-staging - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 idaptik-rescript13-staging development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          pname = "idaptik-rescript13-staging";
          version = "0.1.0";
          src = ./.;
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P idaptik-rescript13-staging.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/idaptik-rescript13-staging $out/bin/  # Rust
            # cp bin/idaptik-rescript13-staging $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/idaptik-rescript13-staging";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-idaptik-rescript13-staging" {
